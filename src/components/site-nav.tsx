    ...
    <header className="sticky top-0 z-40 border-b border-border glass">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-2">
          <div className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-b from-brand to-brand-2 shadow-[0_4px_16px_-4px_rgba(196,107,255,0.6)]">
            <Network className="h-4.5 w-4.5 text-white" />
          </div>
          <div className="leading-none">
            <span className="text-sm font-semibold tracking-tight text-ink">Charter</span>
            <span className="ml-2 hidden text-[11px] text-faint sm:inline">A2A · redelegation</span>
          </div>
        </Link>
